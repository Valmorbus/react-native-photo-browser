...
export default class Photo extends Component {
  ...
  if (orientation == 'LANDSCAPE') {
   this.setState({_width: Dimensions.get('window').height,
   _height: Dimensions.get('window').width })

 }else{
    this.setState({_width: Dimensions.get('window').width,
...
componentDidMount() {
 ...
 componentWillUnmount(){
  ...
  render() {
    var { resizeMode, width, height } = this.props;
    ...
    var sizeStyle = {
      width: width ||  this.state._width,
     //Dimensions.get('window').height,
      height: height || this.state._height,
       //Dimensions.get('window').width,
    };

    return (
      <View onLayout={this.rotateImage} style={[styles.container, sizeStyle]}>
